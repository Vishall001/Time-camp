...
import google from "../Homepage/google.svg";
import Blog from "../Homepage/Blog";
import Toue from "../Homepage/Toue"
import Integration from "../Homepage/Integrations"
import Tab from '../Homepage/Tab'
import SSL from "../Homepage/SSl"
          ...
          >
            ...
            >
              ...
              <button className={Styles.btn2}>
                Or sign up with{" "}
                <img src={google} alt="google" className={Styles.btnimg} />
              </button>
            </Flex>
          </Box>
